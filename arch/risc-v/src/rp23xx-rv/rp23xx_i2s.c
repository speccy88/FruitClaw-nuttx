/****************************************************************************
 * arch/risc-v/src/rp23xx-rv/rp23xx_i2s.c
 *
...
#ifndef CONFIG_RP23XX_RV_I2S_MAXINFLIGHT
#  define CONFIG_RP23XX_RV_I2S_MAXINFLIGHT 16
#endif
...
#  undef CONFIG_RP23XX_RV_I2S_DUMPBUFFERS
#endif
...
#ifndef CONFIG_RP23XX_RV_I2S_DATALEN
...
#  define RP23XX_RV_I2S_DATAMASK  1
#elif  CONFIG_RP23XX_RV_I2S_DATALEN < 8 || CONFIG_RP23XX_RV_I2S_DATALEN > 16
#  error Invalid value for CONFIG_RP23XX_RV_I2S_DATALEN
#else
#  error Valid but supported value for CONFIG_RP23XX_RV_I2S_DATALEN
#endif
...
struct rp23xx_i2s_s
{
  ...
  struct rp23xx_buffer_s containers[CONFIG_RP23XX_RV_I2S_MAXINFLIGHT];
};
...
#ifdef CONFIG_RP23XX_RV_I2S_DUMPBUFFERS
...
static void i2s_buf_initialize(struct rp23xx_i2s_s *priv)
{
  ...
  priv->freelist = NULL;
  nxsem_init(&priv->bufsem, 0, CONFIG_RP23XX_RV_I2S_MAXINFLIGHT);

  for (i = 0; i < CONFIG_RP23XX_RV_I2S_MAXINFLIGHT; i++)
    {
      ...
      case AUDIOIOC_START:
        {
          ...
          if (priv->channels == 1)
            {
              if (priv->datalen == 16)
                mode = RP23XX_RV_I2S_PIO_16BIT_MONO;
              else
                mode = RP23XX_RV_I2S_PIO_8BIT_MONO;
            }
          else
            {
              if (priv->datalen == 16)
                mode = RP23XX_RV_I2S_PIO_16BIT_STEREO;
              else
                mode = RP23XX_RV_I2S_PIO_8BIT_STEREO;
           }
...
static void i2s_configure(struct rp23xx_i2s_s *priv)
{
  ...
  priv->datalen = CONFIG_RP23XX_RV_I2S_DATALEN;
#ifdef CONFIG_DEBUG
  priv->align   = RP23XX_RV_I2S_DATAMASK;
#endif
}
